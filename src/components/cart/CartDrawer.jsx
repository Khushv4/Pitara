...
function CartDrawer() {
  ...
  return (
    <>
      {isCartOpen && (
        <>
          <div className="fixed inset-0 bg-[#3E2723]/20 backdrop-blur-sm z-40 transition-opacity" onClick={() => setIsCartOpen(false)} />
            ...
            {cartItems.length > 0 && (
              <div className="p-6 border-t border-[#EAE3D5] bg-white">
                ...
                <button 
                  ...
                  className="w-full bg-[#3E2723] text-[#FAF8F5] py-4 uppercase tracking-[0.2em] text-xs font-bold hover:bg-[#2C2C2C] transition-colors shadow-sm"
                >
                  Proceed to Checkout
                </button>
              </div>
